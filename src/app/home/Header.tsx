    ...
    <div>
      <div className="overflow-hidden lg:mt-44 mt-12">
        <div className="lg:mb-11 mb-10 px-10 flex justify-center">
          <div className="lg:text-10xl text-8xl text-yellow-400 flex items-center font-black relative uppercase text-center">
            <img
              className="h-[75px] w-screen max-w-none absolute -left-[calc(100vw+40px)] translate-y-3"
              src="/picture/Group 1171275235.png"
              alt=""
            />
            Sweet john
            <img
              className="h-[75px] w-screen max-w-none absolute -right-[calc(100vw+40px)] translate-y-3"
              src="/picture/Group 1171275235.png"
              alt=""
            />
          </div>
      ...
      <div className="container">
        <div>
          ...
          <div className="lg:flex justify-between grid lg:gap-32 gap-16 lg:mb-44 mb-24">
